...
/**
 * @file
 * Contains \Drupal\falpi\Plugin\Preprocess\Page.
 */
...
use Drupal\falpi\Plugin\Preprocess\Home;
...
class Page extends \Drupal\bootstrap\Plugin\Preprocess\Page {
  ...
  private function addLogo(&$variables){
    ...
    global $base_url;
    $src = $base_url . '/' . drupal_get_path('theme', 'falpi') . '/img/logo-falpi.svg';
  ...
  private function addLanguageMenu(&$vars){
    ...
    global $base_url;
    $src = $base_url . '/' . drupal_get_path('theme', 'falpi') . '/img/ico-' . $current_language_id . '.svg';
