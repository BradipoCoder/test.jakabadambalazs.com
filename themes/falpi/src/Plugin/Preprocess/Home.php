...
/**
 * @file
 * Contains \Drupal\falpi\Plugin\Preprocess\Home.
 */
...
class Home{
  ...
  public function preprocess(array &$variables) {
    ...
    unset($variables['page']['content']['falpi_content']);
  }

  private function addCover(&$variables){
    
    $path = drupal_get_path('theme', 'falpi') . '/video/';
    $video = [
      'mp4' => $path . 'home.mp4',
    ...
    $content['systems'] = [
      ...
      '#list' => [
        ...
        1 => [
          ...
          'href' => 'http://configuratore.falpi.com/app/',
          'attributes' => [
  ...
  private function addEco(){
    $content = [
      'image_path' => drupal_get_path('theme', 'falpi') . '/img/falpi-green.jpg',
    ];
  ...
  private function addWebform(){
    ...
    $text .= ' <a href="mailto:info@falpi.com">info@falpi.com</a> ';
    $text .= t('or call us at', [], ['context' => 'contact']);
    $text .= ' <a href="tel:+390157387777">+39&nbsp;015&nbsp;738&nbsp;77&nbsp;77</a> ';
  ...
  private function addCart(){
    $content = [
      'image_path' => drupal_get_path('theme', 'falpi') . '/img/home-cart.jpg',
    ];
  ...
  private function addTextile(){
    $content = [
      'image_path' => drupal_get_path('theme', 'falpi') . '/img/home-textile.jpg',
    ];
  ...
  private function addTools(){
    $content = [
      'image_path' => drupal_get_path('theme', 'falpi') . '/img/home-tools-square.jpg',
    ];
